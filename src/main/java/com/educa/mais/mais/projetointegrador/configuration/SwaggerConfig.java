	...
	public OpenAPI springProjetoIntegradorOpenAPI() {
		return new OpenAPI()
                ...
                .contact(new Contact() // Informações de contato / repositório do projeto
                    ...
                    .url("https://github.com/WesleyCarlos41/projetoIntegrador")))
                .externalDocs(new ExternalDocumentation()
                    .description("Linkdin")
                    .url("https://www.linkedin.com/in/deisesant/\n "
                    		+ "https://www.linkedin.com/in/luis-henrique-seles/\n "
                    		+ "https://www.linkedin.com/in/douglasmichelsantos/\n "
                    		+ "https://www.linkedin.com/in/charlesamorimdev/\n "
                    		+ "https://www.linkedin.com/in/wesley-carlos-cardoso/\n "
                    		+ "https://www.linkedin.com/in/catherinehonorato/\n"
                    		+ "https://www.linkedin.com/in/sabrina-godoy-717773234/\n"));
    }
